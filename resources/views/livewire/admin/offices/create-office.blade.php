<div class="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 space-y-6">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white text-center">Crear Nueva Oficina</h2>
        ...
        <form wire:submit.prevent="save" class="space-y-4">
            ...
            <div class="flex justify-end space-x-3"> {{-- Añadido space-x-3 para separación --}}
                {{-- Botón Cancelar --}}
                <button type="button" {{-- Importante: type="button" para que no envíe el formulario --}}
                        wire:click="cancel" {{-- Llama al nuevo método 'cancel' en el componente Livewire --}}
                        class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-md shadow-sm

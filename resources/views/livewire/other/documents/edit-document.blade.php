<div class="min-h-screen bg-gray-100 p-4 flex items-center justify-center">
    <div class="w-full max-w-4xl bg-white shadow-lg rounded-lg p-6 space-y-6">
        ...
        <form wire:submit.prevent="update" class="space-y-6">
            ...
            {{-- Archivo Adjunto (adaptado de create-document) --}}
            <div>
                <label for="newFile" class="block text-sm font-medium text-gray-700">Archivo Adjunto (PDF, DOC, DOCX - Max 10MB)</label>
            ...
            {{-- Fecha de Registro, Estado y Indicación (adaptado de create-document) --}}
